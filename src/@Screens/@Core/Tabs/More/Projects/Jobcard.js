...
import { getJobCategory, postedByView } from '../../../../@Common/Jobs/JobCard';
...
const Jobcard = ({ JobData }) =>{
    ...
    return(
        <View style={styles.container}>
            <TouchableOpacity style={GlobalStyles.primaryCard} onPress={()=>{navigation.navigate('JobDetails', { jobSlug: jobs_slug })}}>
                {hasCategory ? 
                ...
                <View style={styles.detailsContainer}>
                    ...
                    {days_assignment != '' && <Text style={styles.duration}>{days_assignment} Days Duration</Text>}
                    {(countryName != '' || stateName != '' || assignment_city != '') && <Text style={styles.address}>
                        {countryName}
                        {stateName != '' ? ', ' + stateName : ''}
